-- TODO:
-- * control + backspace to delete a whole word in insert mode
--
--
...
-- Diagnostic keymaps
-- TODO: Make sense of these, and change accordingly. Use them More as well
vim.keymap.set('n', '<leader>de', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- TODO: Make searching more optimized for yourself depending upon usage
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>dd', vim.lsp.buf.code_action, '[D]iagnosic [D]ilemma')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- NOTE: I have disabled this as it was causing bugs with undo.
      -- reformatting everytime due to autosave, making undo obsolete
      --
  ...
  -- FIX:
  -- WARNING:
  -- You can also go and search all of these, hence making your life easier
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'svelte', 'sql' },
